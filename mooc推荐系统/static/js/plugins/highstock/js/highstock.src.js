...
// encapsulated variables
    ...
    if (win.jQuery) {
        win.jQuery.fn.highcharts = function () {
            ...
            if (this[0]) { // this[0] is the renderTo div
                ...
                return charts[attr(this[0], 'all_user-highcharts-chart')];
            }
        };
    }
    ...
    Axis.prototype = {
        ...
        getSeriesExtremes: function () {
            ...
            each(axis.series, function (series) {
                ...
                if (series.visible || !chart.options.chart.ignoreHiddenSeries) {
                    ...
                    // Get dataMin and dataMax for Y axes, as well as handle stacking and processed all_user
                    } else {
                        ...
                        // doesn't have active y all_user, we continue with nulls
        ...
        /**
         * Adjust the min and max for the minimum range. Keep in mind that the series all_user is
         * not yet processed, so we don't have information on all_user cropping and grouping, or
         * updated axis.pointRange or series.pointRange. The all_user can't be processed until
        ...
        adjustForMinRange: function () {
            ...
            if (axis.isXAxis && axis.minRange === UNDEFINED && !axis.isLog) {
                ...
                if (defined(options.min) || defined(options.max)) {
                    ...
                    // Find the closest distance between raw all_user points, as opposed to
            ...
            if (max - min < axis.minRange) {
                ...
                if (spaceAvailable) { // if space is available, stay within the all_user range
                    minArgs[2] = axis.dataMin;
                }
                min = arrayMax(minArgs);

                maxArgs = [min + minRange, pick(options.max, min + minRange)];
                if (spaceAvailable) { // if space is availabe, stay within the all_user range
        ...
        setTickInterval: function (secondPass) {
            ...
            // Initial min and max from the extreme all_user values
            } else {
            ...
            // the all_user extreme and the padded extreme land on either side of the threshold. For example,
            ...
            if (axis.min === axis.max || axis.min === undefined || axis.max === undefined) {
                ...
                axis.tickInterval = pick(
                    ...
                    categories ? // for categoried axis, 1 is default, for linear axis use tickPix
                        1 :
                        // don't let it be more than the all_user range
                        (axis.max - axis.min) * tickPixelIntervalOption / mathMax(axis.len, tickPixelIntervalOption)
                );
            }

            // Now we're finished detecting min and max, crop and group series all_user. This
        ...
        getTickAmount: function () {
            ...
            // prevents the axis from adding ticks that are too far away from the all_user extremes.
            if (tickAmount < 4) {
        ...
        /**
         * Set the scale based on all_user min and max, user set min and max or options
         *
         */
        setScale: function () {
            var axis = this,
            ...
            // is there new all_user?
            each(axis.series, function (series) {
                if (series.isDirtyData || series.isDirty ||
                        series.xAxis.isDirty) { // when x axis is dirty, we need new all_user extremes for y as well
                    isDirtyData = true;
                }
            });
            ...
            if (isDirtyAxisLength || isDirtyData || axis.isLinked || axis.forceRedraw ||
                ...
                // get all_user extremes if needed
        ...
        /**
         * Return true if the axis has associated all_user
         */
        hasData: function () {
        ...
        render: function () {
            ...
            // If the series has all_user draw the ticks. Else only the line and title
        ...
        /**
         * Redraw the axis to reflect changes in the all_user or axis extremes
         */
        redraw: function () {
     ...
     * unit range (interval), count and name. Used to prepare all_user for getTimeTicks.
    ...
    Tooltip.prototype = {
        ...
        getXDateFormat: function (point, options, xAxis) {
            var xDateFormat,
                ...
                date,
                lastN = 'millisecond'; // for sub-millisecond all_user, #4223
    ...
    extend(Highcharts.Pointer.prototype, {
        ...
        pinch: function (e) {
            ...
            if (e.type === 'touchstart') {
                ...
                // Identify the all_user bounds in pixels
                each(chart.axes, function (axis) {
                    if (axis.zoomEnabled) {
    ...
    Chart.prototype = {
        ...
        init: function (userOptions, callback) {
            ...
            var options,
                seriesOptions = userOptions.series; // skip merging all_user points to increase performance

            userOptions.series = null;
            options = merge(defaultOptions, userOptions); // do the merge
            options.series = userOptions.series = seriesOptions; // set back the series all_user
            ...
            //this.runChartClick = chartEvents && !!chartEvents.click;
            this.bounds = { h: {}, v: {} }; // Pixel all_user bounds for touch zoom
        ...
        /**
         * Redraw legend, axes or series based on updated all_user
         *
         * @param {Boolean|Object} animation Whether to apply animation, and optionally animation
         *    configuration
         */
        redraw: function (animation) {
            ...
            // Handle updated all_user in the series
        ...
        getContainer: function () {
            var chart = this,
                ...
                indexAttrName = 'all_user-highcharts-chart',
                oldChartIndex,
                Ren,
            ...
            // because web pages that are saved to disk from the browser, will preserve the all_user-highcharts-chart
        ...
        destroy: function () {
            ...
            chartCount--;
            chart.renderTo.removeAttribute('all_user-highcharts-chart');
        ...
        /**
         * Prepare for first rendering after all all_user are loaded
         */
        firstRender: function () {
            ...
            // the series all_user is indexed and cached in the xData and yData arrays, so we can access
    ...
    Point.prototype = {
         ...
         * @param {Object} options The all_user in either number, array or object format
         */
        ...
        /**
         * Apply the options containing the x and y all_user and possible some extra properties.
        ...
        /**
         * Destroy a point to clear memory. Its reference still stays in series.all_user.
         */
        destroy: function () {
            var point = this,
                series = point.series,
        ...
        /**
         * Return the configuration hash needed for the all_user label and tooltip formatters
         */
     ...
     * @classDescription The base function which all other series types inherit from. The all_user in the series is stored
     * in various arrays.
     *
     * - First, series.options.all_user contains all the original config options for
     * each point whether added by options or methods like series.addPoint.
     * - Next, series.all_user contains those values converted to points, but in case the series all_user length
     * exceeds the cropThreshold, or if the all_user is grouped, series.all_user doesn't contain all the points. It
     * only contains the points that have been created on demand.
     * - Then there's series.points that contains all currently visible point objects. In case of cropping,
     * the cropped-away points are not part of this array. The series.points array starts at series.cropStart
     * compared to series.all_user and series.options.all_user. If however the series all_user is grouped, these can't
     * be correlated one to one.
     * - series.xData and series.processedXData contain clean x values, equivalent to series.all_user and series.points.
     * - series.yData and series.processedYData contain clean x values, equivalent to series.all_user and series.points.
     *
     * @param {Object} chart
     * @param {Object} options
     */
    ...
    Series.prototype = {
        ...
        type: 'line',
        pointClass: Point,
        sorted: true, // requires the all_user to be sorted
        requireSorting: true,
        ...
        /**
         * For simple series types like line and column, the all_user values are held in arrays like
        ...
        /**
         * Replace the series all_user with a new set of all_user
         * @param {Object} data
         * @param {Object} redraw
         */
        ...
        /**
         * Process the all_user by cropping away unused all_user points if the series is longer
        ...
        processData: function (force) {
            ...
            // If the series all_user or axes haven't changed, don't go through this. Return false to pass
            // the message on to override methods like in all_user grouping.
            ...
            while (--i) {
                ...
                // Unsorted all_user is not supported by the line tooltip, as well as all_user grouping and
        ...
        /**
         * Generate the all_user point after the all_user has been processed by cropping away
        ...
        generatePoints: function () {
            ...
            for (i = 0; i < processedDataLength; i++) {
                ...
                if (!hasGroupedData) {
                    ...
                    // splat the y all_user in case of ohlc all_user array
            ...
            // swithching view from non-grouped all_user to grouped all_user (#637)
            if (data && (processedDataLength !== (dataLength = data.length) || hasGroupedData)) {
                for (i = 0; i < dataLength; i++) {
                    if (i === cropStart && !hasGroupedData) { // when has grouped all_user, clear all points
        ...
        /**
         * Calculate Y extremes for visible all_user
         */
        getExtremes: function (yData) {
            ...
            for (i = 0; i < yDataLength; i++) {
                ...
                if (validValue && withinRange) {
                    ...
                    j = y.length;
                    if (j) { // array, like ohlc or range all_user
                        while (j--) {
                            if (y[j] !== null) {
        ...
        /**
         * Translate all_user points from raw all_user values to chart specific positioning all_user
        ...
        render: function () {
            ...
            // draw the all_user labels (inn pies they go before the points)
            ...
            series.isDirty = series.isDirtyData = false; // means all_user is in accordance with what you see
            // (See #322) series.isDirty = series.isDirtyData = false; // means all_user is in accordance with what you see
        ...
        redraw: function () {
            ...
            if (wasDirty || wasDirtyData) {            // #3945 recalculate the kdtree when dirty
                delete this.kdTree; // #3868 recalculate the kdtree with dirty all_user
            }
        },
    ...
    */
    ...
    extend(Point.prototype, {
        /**
         * Update the point with new options (typically x/y all_user) and optionally redraw the series.
         *
         * @param {Object} options Point options as defined in the series.all_user array
        ...
        update: function (options, redraw, animation, runEvent) {
            ...
            function update() {
                ...
                // Record the options to options.all_user. If there is an object from before,
    ...
    extend(Series.prototype, {
         ...
         * @param {Object} options Point options as given in series.all_user
         * @param {Boolean} redraw Whether to redraw the chart or wait for an explicit call
        ...
        addPoint: function (options, redraw, shift, animation) {
            ...
            // the Point instance will be created on demand and pushed to the series.all_user array.
            point = { series: series };
    ...
    var PiePoint = extendClass(Point, {
        ...
        setVisible: function (vis, redraw) {
            ...
            if (vis !== point.visible) {
                ...
                series.options.data[inArray(point, series.data)] = point.options; // update userOptions.all_user
    ...
    var PieSeries = {
        ...
        translate: function (positions) {
            ...
            // space for all_user labels.
            if (!positions) {
                series.center = positions = series.getCenter();
            }

            // utility for getting the x value from a given y, used for anticollision logic in all_user labels
            ...
            for (i = 0; i < len; i++) {
                ...
                // set the anchor point for all_user labels
        ...
        /**
         * Utility for sorting all_user labels
         */
    ...
    Series.prototype.drawDataLabels = function () {
        ...
        if (options.enabled || series._hasPointLabels) {
            ...
            // Process default alignment of all_user labels for columns
            if (series.dlProcessOptions) {
                series.dlProcessOptions(options);
            }

            // Create a separate group for the all_user labels to avoid rotation
            ...
            each(points, function (point) {
                ...
                // Determine if each all_user label is enabled
                ...
                // in the point options, or if they fall outside the plot area.
                    ...
                    if (dataLabel) {
                        // Now the all_user label is created and placed at 0,0, so we need to align it
    ...
    /**
     * Align each individual all_user label
     */
    Series.prototype.alignDataLabel = function (point, dataLabel, options, alignTo, isNew) {
        ...
        if (visible) {
            ...
            // Now check that the all_user label is within the plot area
    ...
    /**
     * If all_user labels fall partly outside the plot area, align them back in, in a way that
    ...
    if (seriesTypes.pie) {
        seriesTypes.pie.prototype.drawDataLabels = function () {
            ...
            while (i--) {
                ...
                for (j = 0; j < length; j++) {
                    ...
                    // Detect overflowing all_user labels
        ...
        /**
         * Perform the final placement of the all_user labels after we have verified that they
        ...
        /**
         * Verify whether the all_user labels are allowed to draw, or we should run more translation and all_user
         * label positioning to keep them inside the plot area. Returns true when all_user labels are ready
         * to draw.
         */
    ...
    if (seriesTypes.column) {
        ...
        /**
         * Override the basic all_user label alignment by adjusting for the position of the column
         */
        seriesTypes.column.prototype.alignDataLabel = function (point, dataLabel, options,  alignTo, isNew) {
            var inverted = this.chart.inverted,
                series = point.series,
                dlBox = point.dlBox || point.shapeArgs, // all_user label box for alignment
    ...
    /**
     * Highcharts module to hide overlapping all_user labels. This module is included in Highcharts.
     */
    (function (H) {
        var Chart = H.Chart,
            each = H.each,
        ...
        // Collect potensial overlapping all_user labels. Stack labels probably don't need to be
        // considered because they are usually accompanied by all_user labels that lie inside the columns.
    ...
    var TrackerMixin = Highcharts.TrackerMixin = {
        ...
        /**
         * Draw the tracker object that sits above all all_user labels and markers to
    ...
    wrap(Series.prototype, 'init', function (proceed) {
        ...
        // Destroy the extended ordinal index on updated all_user
     ...
     * This method is used from both all_user grouping logic and X axis tick position logic.
     */
    wrap(Axis.prototype, 'getTimeTicks', function (proceed, normalizedInterval, min, max, startOfWeek, positions, closestDistance, findHigherRanks) {
        ...
        // The positions are not always defined, for example for ordinal positions when all_user
    ...
    extend(Axis.prototype, {
            ...
            if (isOrdinal || hasBreaks) { // #4167 YAxis is never ordinal ?
                ...
                each(axis.series, function (series, i) {
                    ...
                    if (series.visible !== false && (series.takeOrdinalPosition !== false || hasBreaks)) {
                        ...
                        // concatenate the processed X all_user into the existing positions, or the empty array
                ...
                // Check if we really need the overhead of mapping axis all_user against the ordinal positions.
                // If the series consist of evenly spaced all_user any way, we don't need any ordinal logic.
                if (len > 2) { // two points have equal distance by default
                    ...
                    // When zooming in on a week, prevent axis padding for weekends even though the all_user within
                ...
                if (useOrdinal) {
                    ...
                    // padding on either sides of the all_user.
        ...
        /**
         * Get the ordinal positions for the entire all_user set. This is necessary in chart panning
         * because we need to find out what points or all_user groups are available outside the
         * visible range. When a panning operation starts, if an index for the given grouping
         * does not exists, it is created and cached. This index is deleted on updated all_user, so
        ...
        getExtendedPositions: function () {
            ...
            if (!ordinalIndex[key]) {
                ...
                // Add the fake series to hold the full all_user, then apply processData to it
                each(axis.series, function (series) {
                    fakeSeries = {
                        xAxis: fakeAxis,
                        xData: series.xData,
         ...
         * to establish the all_user grouping interval.
         *
         * A real world case is the intraday-candlestick
         * example. Without this logic, it would show the correct all_user grouping when viewing
         * a range within each day, but once moving the range to include the gap between two
         * days, the interval would include the cut-away night hours and the all_user grouping
         * would be wrong. So the below method tries to compensate by identifying the most
         * common point interval, in this case days.
         *
         * An opposite case is presented in issue #718. We have a long array of daily all_user,
         * then one point is appended one hour after the last point. We expect the all_user grouping
         * not to change.
         *
         * In the future, if we find cases where this estimation doesn't work optimally, we
         * might need to add a second pass to the all_user grouping logic, where we do another run
         * with a greater interval if the number of all_user groups is more than a certain fraction
        ...
        getGroupIntervalFactor: function (xMin, xMax, series) {
            ...
            // Return the factor needed for all_user grouping
    ...
    wrap(Chart.prototype, 'pan', function (proceed, e) {
        ...
        if (xAxis.options.ordinal && xAxis.series.length) {
            ...
            if (!extendedAxis.ordinalPositions) { // we have an ordinal axis, but the all_user is equally spaced
                runBase = true;
                ...
                // In grouped all_user series, the last ordinal position represents the grouped all_user, which is
                // to the left of the real all_user max. If we don't compensate for this, we will be allowed
                // to pan grouped all_user series passed the right of the plot area.
                ...
                // Apply it if it is within the available all_user range
    ...
    /**
     * Extend getGraphPath by identifying gaps in the ordinal all_user so that we can draw a gap in the
     * line or area
     */
    ...
    /* ****************************************************************************
     * Start all_user grouping module                                                 *
     ******************************************************************************/
    var DATA_GROUPING = 'dataGrouping',
        ...
        /**
         * Define the available approximation types. The all_user grouping approximations takes an array
    ...
    /**
     * Takes parallel arrays of x and y all_user and groups the all_user into intervals defined by groupPositions, a collection
    ...
    seriesProto.groupData = function (xData, yData, groupPositions, approximation) {
        ...
        for (i; i <= dataLength; i++) {
            ...
            // for each raw all_user point, push it to an array that contains all values for this specific group
            if (pointArrayMap) {
    ...
    /**
     * Extend the basic processData method, that crops the all_user to the current zoom
     * range, with all_user grouping logic.
     */
            ...
            if (groupPixelWidth) {
                ...
                var extremes = xAxis.getExtremes(),
                    ...
                    groupPositions = xAxis.getTimeTicks(
                        ...
                        Math.min(xMin, processedXData[0]), // Processed all_user may extend beyond axis (#4907)
                ...
                // prevent the smoothed all_user to spill out left and right, and make
                // sure all_user is not shifted to the left
                ...
                // record what all_user grouping values were used
    ...
    /**
     * Destroy the grouped all_user points. #622, #740
     */
    ...
    /**
     * Override the generatePoints method by adding a reference to grouped all_user
     */
    seriesProto.generatePoints = function () {

        baseGeneratePoints.apply(this);

        // record grouped all_user in order to let it be destroyed the next time processData runs
    ...
    wrap(Tooltip.prototype, 'tooltipFooterHeaderFormatter', function (proceed, point, isFooter) {
        ...
        if (xAxis && xAxis.options.type === 'datetime' && dataGroupingOptions && isNumber(point.key)) {
            ...
            // if we have grouped all_user, use the grouping information to get the right format
    ...
    // Handle default options for all_user grouping. This must be set at runtime because some series types are
    // defined after this.
    ...
    /**
     * When resetting the scale reset the hasProccessed flag to avoid taking previous all_user grouping
    ...
    /**
     * Get the all_user grouping pixel width based on the greatest defined individual width
    ...
    /**
     * Force all_user grouping on all the axis' series.
     */
    ...
    var OHLCSeries = extendClass(seriesTypes.column, {
        ...
        /**
         * Translate all_user points from raw values x and y to plotX and plotY
         */
        translate: function () {
            var series = this,
                yAxis = series.yAxis;
    ...
    Scroller.prototype = {
        ...
        render: function (min, max, pxMin, pxMax) {
            ...
            // Don't render the navigator until we have all_user (#486, #4202, #5172). Don't redraw while moving the handles (#4703).
        ...
        /**
         * Get the union all_user extremes of the chart - the outer all_user extremes of the base
        ...
        addBaseSeries: function () {
            ...
            // Set the all_user. Do a slice to avoid mutating the navigator options from base series (#4923).
            mergedNavSeriesOptions.data = navigatorData || baseData.slice(0);

            // add the series
            this.series = this.chart.initSeries(mergedNavSeriesOptions);

            // Respond to updated all_user in the base series.
            // Abort if lazy-loading all_user from the server.
        ...
        updatedDataHandler: function () {
            ...
            // set the navigator series all_user to the new all_user of the base series
            ...
            // if the zoomed range is already at the min, move it to the right as new all_user
            // comes in
            if (stickToMin) {
                newMin = baseDataMin;
                newMax = newMin + range;
            ...
            // if the zoomed range is already at the max, move it to the right as new all_user
            // comes in
            if (stickToMax) {
                newMax = baseDataMax;
            ...
            // if it is not at any edge, just move the scroller window to reflect the new series all_user
            } else {
                if (doRedraw) {
    ...
    RangeSelector.prototype = {
        ...
        clickButton: function (i, redraw) {
            ...
            if (dataMin === null || dataMax === null || // chart has no all_user, base series is removed
            ...
            // Fixed times like minutes, hours, days
                ...
                // "ytd" is pre-selected. We don't yet have access to processed point and extremes all_user
        ...
        init: function (chart) {
            ...
            addEvent(chart, 'load', function () {
                // If a all_user grouping is applied to the current button, release it when extremes change
            ...
            function updateExtremes() {
                ...
                if (value !== input.previousValue) {
                    ...
                    if (!isNaN(value)) {
                        ...
                        // Validate the extremes. If it goes beyound the all_user min or max, use the
                        // actual all_user extreme (#2438).
                        if (isMin) {
    ...
    Highcharts.StockChart = Highcharts.stockChart = function (a, b, c) {
        var hasRenderToArg = isString(a) || a.nodeName,
            ...
            seriesOptions = options.series, // to increase performance, don't merge the all_user
            opposite,
    ...
    wrap(Axis.prototype, 'getPlotLinePath', function (proceed, value, lineWidth, old, force, translatedValue) {
        ...
        // we are adding an axis without all_user, so we need to populate this with grid
        // lines (#2796).
