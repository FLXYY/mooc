...
urlpatterns = [
    path("", views.all_mooc, name="index"),
    path("login/", views.login, name="login"),
    path("register/", views.register, name="register"),
    path("logout/", views.logout, name="logout"),
    # path("item/", views.item, name="item"),
    path("all_mooc/", views.all_mooc, name="all_mooc"),
    path("mooc/<int:mooc_id>/", views.mooc, name="mooc"),
    path("score/<int:mooc_id>/", views.score, name="score"),
    path("comment/<int:mooc_id>/", views.commen, name="comment"),
    path("good/<int:commen_id>/<int:mooc_id>/", views.good, name="good"),
    path("collect/<int:mooc_id>/", views.collect, name="collect"),
    path("decollect/<int:mooc_id>/", views.decollect, name="decollect"),
    ...
    # 收藏最多
    path("hot_mooc/", views.hot_mooc, name="hot_mooc"),
    path("most_view/", views.most_view, name="most_view"),
    path("most_mark/", views.most_mark, name="most_mark"),
    path("latest_mooc/", views.latest_mooc, name="latest_mooc"),
